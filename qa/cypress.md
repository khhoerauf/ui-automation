...
2. Ensure that you have at least one modern browser (Chrome or Firefox) installed. All supported browsers can be found [here](https://docs.cypress.io/app/references/launching-browsers#Browsers)
3. `cd qa/`
4. Run `npm install` to install the required dependencies
5. Run `npm start` to start running application at http://localhost:5173/
...
Please read the standalone document [here](./test-report.md).